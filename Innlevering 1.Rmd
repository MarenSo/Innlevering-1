...
Kan du gjøre det som gjenstår og mangler? Vi mangler: 
...
-   Vi mangler kilder i teksten en del steder.

-   Minst et eksempel på bruk av følgende: **bold** ***italicbold***

- Kan du se om du får til å lagre litteraturliste med bruk av @? Jeg får det ikke til, selvom jeg har lagt inn bib og csl i mappen og i dette dokumentet. 
...
![git log/siste commits. Bildet viser siste commits, og at det er brukt flere branches (her: master, teori og konklusjon)](git.log.jpg)
